...
2. **Budget** — ``budget_krw`` must agree (±1%) with an amount parsed by :mod:`mulmit.domain.krw`
...
from mulmit.domain.krw import amounts_agree, find_amounts
from mulmit.domain.text import collapse_ws, normalize_with_map
