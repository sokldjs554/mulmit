...
from mulmit.demo.archetypes import (
    ARCHETYPES,
    FILLER_TOPICS,
    GIVEN,
    OPERATING_LINES,
...
from mulmit.domain.institutions import Institution, InstitutionRegistry, load_registry_csv
from mulmit.domain.krw import find_amounts
from mulmit.domain.timing import resolve_timing
from mulmit.sources.base import RawRecord
from mulmit.sources.g2b import map_item
...
def _arch(key: str) -> Archetype:
    from mulmit.demo.archetypes import BY_KEY
